...
class KerasConvLayer(Layer):
    ...
    **Example**
    ...
    def __init__(
        ...
        ##########Output dim needs to be modified here for convolution i.e feature map############
        self.output_dim = output_dim #if isinstance(output_dim, Iterable) else output_dim
